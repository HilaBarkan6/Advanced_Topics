...
{   
    protected:
        ...
        // Check if there is a path from src (can be tank or shell) with direction to the dst.
        bool clearPathFromSrcToDst(const Board& board, const int src_x, const int src_y, const int dst_x, const int dst_y, const CanonDirection dir) const;
