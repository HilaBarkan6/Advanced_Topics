...
class PlayerImp : public Player {
    ...
    protected:
        ...
        void putLocationByChar(char object_sign, int x, int y); // This function updates the battle_info with the location of the object based on its character representation.
    private:
