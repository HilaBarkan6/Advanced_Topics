...
#include "tests/players/RotatingPlayer.h"
#include "tests/players/SimplePlayer.h"
#include "tests/players/SecondPlayer.h"
...
int main() {
    try {
        ...
        std::string input2 = "tests/input/input_2.txt";
        std::string output2 = "tests/output/output_input_2.txt";
        ...
        std::string input3 = "tests/input/input_3.txt";
        std::string output3 = "tests/output/output_input_3.txt";
        ...
        std::string input4 = "tests/input/input_4.txt";
        std::string output4 = "tests/output/output_input_4.txt";
        ...
        std::string input5 = "tests/input/input_5.txt";
        std::string output5 = "tests/output/output_input_5.txt";
        ...
        std::string input6 = "tests/input/input_6.txt";
        std::string output6 = "tests/output/output_input_6.txt";
        ...
        std::string input7 = "tests/input/input_7.txt";
        std::string output7 = "tests/output/output_input_7.txt";
        ...
        std::string input9 = "tests/input/input_9.txt";
        std::string output9 = "tests/output/output_input_9.txt";
        ...
        std::string input10 = "tests/input/input_10.txt";
        std::string output10 = "tests/output/output_input_10.txt";
        ...
        std::string input11 = "tests/input/input_11.txt";
        std::string output11 = "tests/output/output_input_11.txt";
        ...
        std::string input12 = "tests/input/input_12.txt";
        std::string output12 = "tests/output/output_input_12.txt";
        ...
        // std::string input8 = "tests/input/input_8.txt";
        // std::string output8 = "tests/output/output_input_8.txt";
